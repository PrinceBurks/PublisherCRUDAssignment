...
import org.wecancodeit.gamelibrary.Repos.BoardGameRepo;
...
public class Populator implements CommandLineRunner {
    ...
    @Resource
    private BoardGameRepo bRepository;

    @Resource
    private PublisherRepo pRepository;

    public Populator(BoardGameRepo bRepository, PublisherRepo pRepository) {
